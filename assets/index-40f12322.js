var At=Object.defineProperty;var kt=(l,n,t)=>n in l?At(l,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[n]=t;var A=(l,n,t)=>(kt(l,typeof n!="symbol"?n+"":n,t),t),Q=(l,n,t)=>{if(!n.has(l))throw TypeError("Cannot "+t)};var m=(l,n,t)=>(Q(l,n,"read from private field"),t?t.call(l):n.get(l)),b=(l,n,t)=>{if(n.has(l))throw TypeError("Cannot add the same private member more than once");n instanceof WeakSet?n.add(l):n.set(l,t)},I=(l,n,t,e)=>(Q(l,n,"write to private field"),e?e.call(l,t):n.set(l,t),t);var w=(l,n,t)=>(Q(l,n,"access private method"),t);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))e(r);new MutationObserver(r=>{for(const u of r)if(u.type==="childList")for(const y of u.addedNodes)y.tagName==="LINK"&&y.rel==="modulepreload"&&e(y)}).observe(document,{childList:!0,subtree:!0});function t(r){const u={};return r.integrity&&(u.integrity=r.integrity),r.referrerPolicy&&(u.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?u.credentials="include":r.crossOrigin==="anonymous"?u.credentials="omit":u.credentials="same-origin",u}function e(r){if(r.ep)return;r.ep=!0;const u=t(r);fetch(r.href,u)}})();function _(l){const n=new Date(l),t=n.getUTCHours().toString(),e=n.getUTCMinutes().toString().padStart(2,"0"),r=n.getUTCSeconds().toString().padStart(2,"0");return t==="0"?e.concat(":",r):t.concat(":",e).concat(":",r)}function ut(l,n){for(const t of Object.entries(n))l.setAttribute(t[0],t[1]);return l}var Z=typeof Z=="object"?Z:{};Z.Widget=function(l){var n={};function t(e){if(n[e])return n[e].exports;var r=n[e]={i:e,l:!1,exports:{}};return l[e].call(r.exports,r,r.exports,t),r.l=!0,r.exports}return t.m=l,t.c=n,t.d=function(e,r,u){t.o(e,r)||Object.defineProperty(e,r,{enumerable:!0,get:u})},t.r=function(e){typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},t.t=function(e,r){if(1&r&&(e=t(e)),8&r||4&r&&typeof e=="object"&&e&&e.__esModule)return e;var u=Object.create(null);if(t.r(u),Object.defineProperty(u,"default",{enumerable:!0,value:e}),2&r&&typeof e!="string")for(var y in e)t.d(u,y,function(x){return e[x]}.bind(null,y));return u},t.n=function(e){var r=e&&e.__esModule?function(){return e.default}:function(){return e};return t.d(r,"a",r),r},t.o=function(e,r){return Object.prototype.hasOwnProperty.call(e,r)},t.p="",t(t.s=0)}([function(l,n,t){var e,r,u,y=t(1),x=t(2),T=t(3),f=y.api,K=y.bridge,et=[],$=[],St=/^http(?:s?)/;function H(i){var s,a;for(s=0,a=$.length;s<a&&i($[s])!==!1;s++);}function C(i){return i.contentWindow?i.contentWindow:i.contentDocument&&"parentWindow"in i.contentDocument?i.contentDocument.parentWindow:null}function nt(i){var s,a=[];for(s in i)i.hasOwnProperty(s)&&a.push(i[s]);return a}function J(i,s,a){a.callbacks[i]=a.callbacks[i]||[],a.callbacks[i].push(s)}function it(i,s){var a=!0;return s.callbacks[i]=[],H(function(o){if((o.callbacks[i]||[]).length)return a=!1,!1}),a}function R(i,s,a){var o,c,d=C(a);if(!d.postMessage)return!1;o=a.getAttribute("src").split("?")[0],c=JSON.stringify({method:i,value:s}),o.substr(0,2)==="//"&&(o=window.location.protocol+o),o=o.replace(/http:\/\/(w|wt).soundcloud.com/,"https://$1.soundcloud.com"),d.postMessage(c,o)}function D(i){var s;return H(function(a){if(a.instance===i)return s=a,!1}),s}function st(i){var s;return H(function(a){if(C(a.element)===i)return s=a,!1}),s}function xt(i,s){return function(a){var o,c=!!((o=a)&&o.constructor&&o.call&&o.apply),d=D(this),h=!c&&s?a:null,p=c&&!s?a:null;return p&&J(i,p,d),R(i,h,d.element),this}}function ot(i,s,a){var o,c,d;for(o=0,c=s.length;o<c;o++)i[d=s[o]]=xt(d,a)}function rt(i,s,a){return i+"?url="+s+"&"+function(o){var c,d,h=[];for(c in o)o.hasOwnProperty(c)&&(d=o[c],h.push(c+"="+(c==="start_track"?parseInt(d,10):d?"true":"false")));return h.join("&")}(a)}function X(i,s,a){var o,c,d=i.callbacks[s]||[];for(o=0,c=d.length;o<c;o++)d[o].apply(i.instance,a);(function(h){var p,k=!1;for(p in x)if(x.hasOwnProperty(p)&&x[p]===h){k=!0;break}return k}(s)||s===f.READY)&&(i.callbacks[s]=[])}function at(i){var s,a,o,c,d;try{a=JSON.parse(i.data)}catch{return!1}return s=st(i.source),o=a.method,c=a.value,(!s||lt(i.origin)===lt(s.domain))&&(s?(o===f.READY&&(s.isReady=!0,X(s,"__LATE_BINDING__"),it("__LATE_BINDING__",s)),o!==f.PLAY||s.playEventFired||(s.playEventFired=!0),o!==f.PLAY_PROGRESS||s.playEventFired||(s.playEventFired=!0,X(s,f.PLAY,[c])),d=[],c!==void 0&&d.push(c),void X(s,o,d)):(o===f.READY&&et.push(i.source),!1))}function lt(i){return i.replace(St,"")}window.addEventListener?window.addEventListener("message",at,!1):window.attachEvent("onmessage",at),l.exports=u=function(i,s,a){var o;if(((o=i)===""||o&&o.charCodeAt&&o.substr)&&(i=document.getElementById(i)),!function(p){return!(!p||p.nodeType!==1||p.nodeName.toUpperCase()!=="IFRAME")}(i))throw new Error("SC.Widget function should be given either iframe element or a string specifying id attribute of iframe element.");s&&(a=a||{},i.src=rt("http://wt.soundcloud.test:9200/",s,a));var c,d,h=st(C(i));return h&&h.instance?h.instance:(c=et.indexOf(C(i))>-1,d=new e(i),$.push(new r(d,i,c)),d)},u.Events=f,window.SC=window.SC||{},window.SC.Widget=u,r=function(i,s,a){this.instance=i,this.element=s,this.domain=function(o){var c,d,h,p="";for(o.substr(0,2)==="//"&&(o=window.location.protocol+o),h=o.split("/"),c=0,d=h.length;c<d&&c<3;c++)p+=h[c],c<2&&(p+="/");return p}(s.getAttribute("src")),this.isReady=!!a,this.callbacks={}},(e=function(){}).prototype={constructor:e,load:function(i,s){if(i){s=s||{};var a=this,o=D(this),c=o.element,d=c.src,h=d.substr(0,d.indexOf("?"));o.isReady=!1,o.playEventFired=!1,c.onload=function(){a.bind(f.READY,function(){var p,k=o.callbacks;for(p in k)k.hasOwnProperty(p)&&p!==f.READY&&R(K.ADD_LISTENER,p,o.element);s.callback&&s.callback()})},c.src=rt(h,i,s)}},bind:function(i,s){var a=this,o=D(this);return o&&o.element&&(i===f.READY&&o.isReady?setTimeout(s,1):o.isReady?(J(i,s,o),R(K.ADD_LISTENER,i,o.element)):J("__LATE_BINDING__",function(){a.bind(i,s)},o)),this},unbind:function(i){var s,a=D(this);a&&a.element&&(s=it(i,a),i!==f.READY&&s&&R(K.REMOVE_LISTENER,i,a.element))}},ot(e.prototype,nt(x)),ot(e.prototype,nt(T),!0)},function(l,n){n.api={LOAD_PROGRESS:"loadProgress",PLAY_PROGRESS:"playProgress",PLAY:"play",PAUSE:"pause",FINISH:"finish",SEEK:"seek",READY:"ready",OPEN_SHARE_PANEL:"sharePanelOpened",CLICK_DOWNLOAD:"downloadClicked",CLICK_BUY:"buyClicked",ERROR:"error"},n.bridge={REMOVE_LISTENER:"removeEventListener",ADD_LISTENER:"addEventListener"}},function(l,n){l.exports={GET_VOLUME:"getVolume",GET_DURATION:"getDuration",GET_POSITION:"getPosition",GET_SOUNDS:"getSounds",GET_CURRENT_SOUND:"getCurrentSound",GET_CURRENT_SOUND_INDEX:"getCurrentSoundIndex",IS_PAUSED:"isPaused"}},function(l,n){l.exports={PLAY:"play",PAUSE:"pause",TOGGLE:"toggle",SEEK_TO:"seekTo",SET_VOLUME:"setVolume",NEXT:"next",PREV:"prev",SKIP:"skip"}}]);var P,g,q,dt,W,pt;const tt=class{constructor(n,{trackId:t}){b(this,q);b(this,P,"");b(this,g,void 0);A(this,"paused",!0);var e;I(this,P,n),I(this,g,w(e=tt,W,pt).call(e,m(this,P),t))}get widget(){return m(this,g)}onMounted(n){m(this,g).bind(SC.Widget.Events.READY,()=>{m(this,g).isPaused(w(this,q,dt)),m(this,g).getDuration(t=>{n({duration:t})})})}onPlaying(n){m(this,g).bind(SC.Widget.Events.PLAY_PROGRESS,n)}onLoading(n){m(this,g).bind(SC.Widget.Events.LOAD_PROGRESS,t=>{console.log("onloading => ",t),n(t)})}onPlay(n){m(this,g).bind(SC.Widget.Events.PLAY,n)}onPause(n){m(this,g).bind(SC.Widget.Events.PAUSE,n)}goTo(n){m(this,g).seekTo(n)}getTimelinePosition(n){m(this,g).bind(SC.Widget.Events.SEEK,n)}play(){m(this,g).play()}pause(){m(this,g).pause()}};let N=tt;P=new WeakMap,g=new WeakMap,q=new WeakSet,dt=function(n){this.paused=n},W=new WeakSet,pt=function(n,t){const e={id:`snd-widget-${Date.now()}`,width:"100%",height:"50%",scrolling:"no",allow:"autoplay",frameBorder:"no",src:`https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/${t}&amp;`},r=ut(document.createElement("iframe"),e);return document.querySelector(n).appendChild(r),SC.Widget(r.id)},b(N,W);var O;const L=class{constructor(n){b(this,O,void 0);I(this,O,n)}get status(){return m(this,O)}};let v=L;O=new WeakMap,A(v,"LOADING",new L("loading")),A(v,"PLAYING",new L("playing")),A(v,"PAUSED",new L("paused"));const ct={button:`<span class="play">
...
`};var M,ht,G,gt,U,mt,Y,bt,z,ft,B,Et,j,yt,F,wt,V,vt;const S=class extends HTMLElement{constructor({trackId:t}){super();b(this,M);b(this,G);A(this,"style");this.color="#6a6a6a",this.trackId=t,this.SndWidget=new N("#snd",{trackId:this.trackId}),this.shadow=this.attachShadow({mode:"open"}),this.main()}main(){this.SndWidget.onMounted(({duration:t})=>{var e,r,u,y,x,T,f;this.duration=t,this.containerElement=w(e=S,U,mt).call(e),this.buttonElement=w(r=S,Y,bt).call(r,ct.button),this.timeElement=w(u=S,z,ft).call(u),this.timeElapsedElement=w(y=S,j,yt).call(y,this.duration),this.progressElement=w(x=S,B,Et).call(x,this.duration),this.equalizerElement=w(T=S,F,wt).call(T,ct.eq),this.style=w(f=S,V,vt).call(f,this.color),w(this,M,ht).call(this),w(this,G,gt).call(this)})}onPlayButton(){this.SndWidget.widget.isPaused(t=>t?this.SndWidget.play():this.SndWidget.pause())}onProgressChange({target:t}){this.SndWidget.goTo(t.value),this.updateProgress(t.value)}updateButtonState(t){switch(t){case v.LOADING.status:this.buttonElement.classList.add("loading"),this.buttonElement.classList.remove("playing"),this.equalizerElement.classList.remove("playing");break;case v.PLAYING.status:this.buttonElement.classList.add("playing"),this.buttonElement.classList.remove("loading"),this.equalizerElement.classList.add("playing");break;case v.PAUSED.status:this.buttonElement.classList.remove("playing"),this.buttonElement.classList.remove("loading"),this.equalizerElement.classList.remove("playing");break}}updateTimers(t){this.timeElement.innerText=_(t),this.timeElapsedElement.innerText="-"+_(this.duration-t)}updateProgress(t){this.progressElement.value=t;const e=this.progressElement.min,r=this.progressElement.max,u=this.progressElement.value;this.progressElement.style.backgroundSize=(u-e)*100/(r-e)+"% 100%"}static define(t){try{customElements.define(t,this)}catch{console.log(`Couldn't (re)define ${t} element`)}}};let E=S;M=new WeakSet,ht=function(){this.buttonElement.setAttribute("data-track",this.trackId),this.shadow.appendChild(this.style),this.shadow.appendChild(this.containerElement),this.containerElement.appendChild(this.buttonElement),this.containerElement.appendChild(this.equalizerElement),this.containerElement.appendChild(this.timeElement),this.containerElement.appendChild(this.progressElement),this.containerElement.appendChild(this.timeElapsedElement)},G=new WeakSet,gt=function(){this.buttonElement.addEventListener("click",t=>this.onPlayButton(t)),this.progressElement.addEventListener("input",t=>this.onProgressChange(t)),this.SndWidget.onPlay(()=>{console.log("on play"),this.SndWidget.widget.isPaused(t=>t?this.updateButtonState(v.PAUSED.status):this.updateButtonState(v.PLAYING.status))}),this.SndWidget.onPause(()=>{console.log("on paused"),this.updateButtonState(v.PAUSED.status)}),this.SndWidget.onPlaying(({currentPosition:t})=>{this.updateTimers(t),this.updateProgress(t)}),this.SndWidget.onLoading(()=>{console.log("on loading"),this.updateButtonState(v.LOADING.status)}),this.SndWidget.getTimelinePosition(({currentPosition:t})=>{this.updateTimers(t)})},U=new WeakSet,mt=function(){const t=document.createElement("div");return t.setAttribute("class","snd-player"),t},Y=new WeakSet,bt=function(t){const e=document.createElement("button");return e.setAttribute("class","snd-player-button"),e.innerHTML=t,e},z=new WeakSet,ft=function(){const t=document.createElement("div");return t.setAttribute("class","snd-player-time"),t.innerText=_(0),t},B=new WeakSet,Et=function(t){const e={type:"range",value:0,min:0,max:t,class:"timeline-progress-bar"},r=document.createElement("div");r.setAttribute("class","snd-player-timeline"),r.style.width="100%";const u=ut(document.createElement("input"),e);return r.appendChild(u),u},j=new WeakSet,yt=function(t){const e=document.createElement("div");return e.setAttribute("class","snd-player-time"),e.innerText=_(t),e},F=new WeakSet,wt=function(t){const e=document.createElement("div");return e.setAttribute("class","equaliser-container"),e.innerHTML=t,e},V=new WeakSet,vt=function(t){const e=document.createElement("style");return e.textContent=`
        ...
        @keyframes color-bar {
           ...
           `,e},b(E,U),b(E,Y),b(E,z),b(E,B),b(E,j),b(E,F),b(E,V),A(E,"purple","#747bff"),A(E,"violet","#922cf9"),A(E,"dark","#1e1c20");window.onload=()=>{E.define("tony-montana");const l=new E({trackId:1408738531});document.querySelector("#app").appendChild(l),console.log(l)};
